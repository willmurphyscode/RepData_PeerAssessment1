...
```
It seems that the method of imputing the data has very little effect on its distribution. The mean steps per day with imputed values was `r meanWithImputed`, and without imputed was `r meanPerDay`. The median with imputed values was `r medianWithImputed`, and before the imputed data were added, the median was `r medianPerDay`.
